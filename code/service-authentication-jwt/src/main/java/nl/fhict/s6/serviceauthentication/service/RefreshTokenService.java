...
import nl.fhict.s6.serviceauthentication.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${game-highlights.app.jwtRefreshExpirationMs}")
    ...
    public RefreshTokenDao createRefreshToken(Long userId) {
        RefreshTokenDao refreshToken = new RefreshTokenDao();
    ...
    public RefreshTokenDao verifyExpiration(RefreshTokenDao token) {
